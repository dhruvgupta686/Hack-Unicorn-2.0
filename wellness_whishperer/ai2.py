...
diabetes_model = pickle.load(open('C:/Users/Rajiv Arora/Desktop/AI-model@/saved models/diabetes_model.sav', 'rb'))


parkinsons_model = pickle.load(open('C:/Users/Rajiv Arora/Desktop/AI-model@/saved models/parkinsons_model.sav', 'rb'))
